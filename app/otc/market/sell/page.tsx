...
export default function MarketSellPage() {
  ...
  const currentPrice = priceData.lbankKrwPrice
    ...
    : null;
  const sellPrice = priceData.lbankKrwPrice
    ? Math.round(priceData.lbankKrwPrice * 0.97)
    : null;
  ...
  return (
    <PageLayout>
      <PageContainer>
        <MainContent>
          <TitleCard>
            <PageTitle>시장가 판매</PageTitle>
            <PageDescription>
              LBANK 현재가 기준 -3% 가격으로 판매 신청할 수 있습니다.
            </PageDescription>
          </TitleCard>
          ...
          <PriceCard>
            ...
            {!isLoading && !error && currentPrice !== null && sellPrice !== null && (
              <>
                ...
                <MarketPriceRow>
                  <MarketPriceLabel>시장가 판매 가격</MarketPriceLabel>
                  <MarketPriceValue>{sellPrice.toLocaleString()}원</MarketPriceValue>
                </MarketPriceRow>
              </>
            )}
          </PriceCard>
